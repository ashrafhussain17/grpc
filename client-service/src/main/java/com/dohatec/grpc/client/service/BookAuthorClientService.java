...
import com.dohatec.Author;
import com.dohatec.Book;
...
public class BookAuthorClientService {
    ...
    public Map<Descriptors.FieldDescriptor, Object> getAuthor(int authorId) {
        ...
        metadata.put(Metadata.Key.of("jwt_token", Metadata.ASCII_STRING_MARSHALLER), "sdffgdhfg");
        MetadataUtils.attachHeaders(synchronousClient, metadata);
